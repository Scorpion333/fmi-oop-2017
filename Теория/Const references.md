...
- подаваме обикновена референция, когато функцията може да промени обекта (и искаме той да се промени) - тогава не можем да подаваме константи.
- подаваме const референция, когато функцията не променя обекта по никакъв начин - тогава е ОК да се подават константи.
