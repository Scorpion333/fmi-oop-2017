...
Също както и [const референцията](https://github.com/Scorpion333/fmi-oop-2017/blob/master/Теория/Const%20references.md),
указателят към константа влиза в употреба при писането на функции.
Понякога няма как да декларираме аргумента като референция - например, когато функцията приема масив
или когато е възможно да подадем [NULL](https://github.com/Scorpion333/fmi-oop-2017/blob/master/Теория/NULL.md).
