...
E, за да можем да напишем (cout << a) << b, и това да е същото, както
...
Това е така, защото всеки двуместен оператор в C++ попада в една от следните категории:

- Ляво асоциатевни - ако има верижка, първо се изпълнява най-левия оператор и се продължава нядясно. Такива са << и >>.
- Дясно асоциативни - ако има верижка, първо се изпълнява най-десния оператор и се продължава наляво. Такъв е =.

Въпреки че можем да накараме оператора, който дефинираме, да прави каквото му кажем, посокато на асоциатевността не може да се промени -
