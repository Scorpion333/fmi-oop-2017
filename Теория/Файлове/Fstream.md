# #include\<fstream\> (Текстови файлове)
...
Дейстивето на оператора е различно, в зависимост от типа отдясно и това накъде сочи указателя - дали е достигнал края на файла и какъв символ сочи.
(Интервалите, знаците за нов ред и табулациите не се записват, но се използват за разделители.)
...
Не ги дефинираме като методи, а като външни функции, за да може от лявата страна на оператора да стои stream-ът, а отдясно - обектът от нашия клас.
